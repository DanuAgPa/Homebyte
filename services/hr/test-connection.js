...
async function testConnection() {
  ...
  try {
    ...
    // Upload a small file
    const fileName = 'hr-test.txt';
    fs.writeFileSync(fileName, 'Hello from HR Service MinIO test!');
